    ...
    */
    'drivers' => [
        ...
        'paypal' => [
            ...
            'id' => '', // Specify the mail of the PayPal Business account
            'callbackUrl' => 'http://yoursite.com/path/to',
        ...
        'zarinpal' => [
            ...
            'mode' => 'normal',
            'merchantId' => '1ecfc2c2-e3ce-4c8a-8280-aa20717f50b1',
            'callbackUrl' => 'https://kohnawardimatin.com/order/verify/payment',
            'description' => 'payment using kohnawardimatin',
            'currency' => 'T', //Can be R, T (Rial, Toman)
        ],
        'zibal' => [
            /* normal api */
