                ...
                <div class="card mt-4">
                    <div class="card-body pt-5">
                        <div class="py-4 col-12 col-md-8 m-auto">
                            ...
                            <span class="float-left pl-2 m-2 m-2 p-2"><span><i class="fas fa-headset display-2"></i></span></span>
                        </div>
                        ...
                        <div class="row ">
                            <div class="col-12 col-md-8 m-auto">
                                ...
                                <div class="alert alert-success rounded py-3">
                                    <h6 class="justify-width py-2"> تلفن تماس و فکس: {{$setting->media->tel}}<span class="h6 pr-2">(پاسخگویی 24 ساعته، 7 روز هفته)</span></h6>
                                </div>
                                <br>
                                ...
                                <h6 class="py-2 text-justify justify-width">لطفا برای ارتباط با مشاوران ما از طریق شماره تلفن {{' '.$setting->media->tel.' '}} اقدام فرمایید.</h6>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-12 col-md-8 m-auto">
                                ...
                                <span class="text-muted py-4 h4">ایمیل سازمانی {{$setting->title}}: <a href="mailto:{{$setting->media->email}}">{{$setting->media->email}}</a></span>
                            </div>
                        </div>
                    </div>
                </div>
