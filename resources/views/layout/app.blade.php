...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-vazir">
...
<div class="fixed bottom-4 left-4">
    <button id="theme-toggle" type="button" class="bg-purple-700 text-white p-3 rounded-full shadow-lg">
