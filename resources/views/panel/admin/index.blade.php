...
@section('content')
    <div class="container px-6 mx-auto grid">
        ...
        <!-- Card -->
        <div class="grid gap-6 mb-8 md:grid-cols-2 sm:grid-cols-4">
            <!-- Card -->
            <div>
                <a href="{{route('comments.index')}}" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            {{\App\Helpers\Helper::DashboardAlert()['commentCount']}}
                        </p>
                    </div>
                </a>
            </div>
            <!-- Card -->
            <div>
                <a href="{{route('customers.index')}}" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            {{\App\Helpers\Helper::DashboardAlert()['userCount']}}
                        </p>
                    </div>
                </a>
            </div>
            <!-- Card -->
            <div>
                <a href="{{route('contacts.index')}}" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            {{\App\Helpers\Helper::DashboardAlert()['contactCount']}}
                        </p>
                    </div>
                </a>
            </div>
            <!-- Card -->
            <div>
                <a href="{{route('payments.index')}}" class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                            {{\App\Helpers\Helper::DashboardAlert()['paymentCount']}}
                        </p>
                    </div>
                </a>
            </div>
		...
		<div>
            <a href="{{url('/clear')}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-auto">
                ...
                <div class="w-full overflow-x-auto">
                        <table class="w-full ">
                            ...
                            <tr class="text-sm font-bold tracking-wide text-center text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800" >
                                ...
                                <th class="px-4 py-3">{{__('dashboard.amount')}}</th>
                                <th class="px-4 py-3">{{__('dashboard.status')}}</th>
                                <th class="px-4 py-3">{{__('dashboard.status_send')}}</th>
...
@section('script')
    ...
    <script src="{{url('/js/charts-lines.js')}}" ></script>
    <script src="{{url('/js/charts-pie.js')}}" ></script>
@endsection
