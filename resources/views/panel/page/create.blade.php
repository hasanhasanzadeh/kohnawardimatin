    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs" >
            <div class="w-full overflow-x-auto">
                <form class="w-full" method="post" action="{{route('pages.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="flex flex-wrap mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3  my-3">
                            ...
                            <select name="page_cat_id" class="appearance-none px-10 block dark:bg-gray-700 dark:text-gray-200 w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 focus:outline-none focus:bg-white focus:border-gray-500 text-left" id="page_cat_id">
                                <option value="">{{__('dashboard.page_cat_select')}}</option>
                            </select>
                        </div>
                        <div class="w-full md:w-1/2 px-3  my-3">
