                ...
                <form class="w-full" method="post" action="{{route('permissions.update',$permission->id)}}">
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3  my-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="name" name="name" type="text" value="{{$permission->name}}" placeholder="{{__('dashboard.enterName')}}">
                        </div>
                        <div class="w-full md:w-1/2 px-3 my-3">
