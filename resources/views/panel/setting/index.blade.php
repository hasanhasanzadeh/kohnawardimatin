...
@section('content')
    <div class="container px-6 mx-auto grid">
        ...
        <a href="{{route('settings.create')}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-auto">
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <a href="{{route('settings.edit',$panel->id)}}" class="text-yellow-400 mx-auto" title="{{__('dashboard.edit')}}">
                                        ...
                                        <form action="{{route('settings.destroy',$panel->id)}}" class="mx-auto" method="POST">
                                            @csrf
                                            {{method_field('DELETE')}}
