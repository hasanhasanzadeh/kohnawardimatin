                ...
                <form class="w-full" method="post" action="{{route('symbols.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap mx-3 my-2 relative">
                        ...
                        <div class="w-full px-3 my-3">
                            ...
                            <textarea class="appearance-none block w-full bg-gray-200 dark:bg-gray-700 dark:text-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" rows="5" id="description" name="description"  placeholder="{{__('dashboard.enterDescription')}}">{{old('description')}}</textarea>
                        </div>
                        <div class="w-full px-3 my-3">
