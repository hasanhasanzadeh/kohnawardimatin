            ...
            <div class="row">
                <div class="account-box checkout-page col-xl-9 col-lg-8 col-md-12">
                    ...
                    <div class="account-box-content">
                        <form action="{{route('addresses.createNew')}}" method="POST" class="form-account">
                            @csrf
                            <div class="form-account-title"> نام و نام خانوادگی گیرنده </div>
                            <div class="form-account-row">
                                <input type="text" name="receptor_name" value="{{old('receptor_name')?old('receptor_name'):auth()->user()->name}}" class="input-field text-right" placeholder="نام و نام خانوادگی گیرنده را وارد کنید">
                            </div>
                            <div class="form-account-title"> شماره تماس گیرنده </div>
                            <div class="form-account-row">
                                <input type="tel" maxlength="11" name="receptor_mobile" value="{{old('receptor_mobile')?old('receptor_mobile'):auth()->user()->mobile}}" class="input-field text-right" placeholder="شماره تماس گیرنده را وارد کنید">
                            </div>
                            <div class="form-account-title"> آدرس  </div>
                            <div class="form-account-row">
                                <textarea  name="address" class="input-field text-right" placeholder="آدرس گیرنده را وارد کنید">{{old('address')}}</textarea>
                            </div>
                            ...
                            <div class="form-account-row">
                                <input  name="post_code" maxlength="10" type="text" value="{{old('post_code')}}" class="input-field text-right" placeholder="کد پستی گیرنده را وارد کنید">
                            </div>
