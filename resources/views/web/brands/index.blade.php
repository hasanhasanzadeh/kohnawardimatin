                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-9 order-1">
                     <div class="breadcrumb-section default">
                        <ul class="breadcrumb-list">
                            ...
                            <li><span>برند ها </span></li>
                        </ul>
                    </div>
                     <div class="listing default">
                        <div class="listing-counter">{{ $products_show->count() }} کالا</div>
                            ...
                            <div class=" active" id="related">
                                <div class="container no-padding-right">
                                    <ul class="row listing-items">
                                        @foreach($products_show as $key => $product)
                        ...
                        <div class="pager default text-center">
                            <ul class="pager-items">
                                <li class="py-2 my-2 text-info">
                                    {!! $products_show->appends(Request::except('page'))->render('pagination::bootstrap-4') !!}
                                </li>
                            </ul>
                        </div>
                    </div>
