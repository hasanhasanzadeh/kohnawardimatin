...
@section('meta')
    <meta property="og:url" content="{{url('/category/show/'.$cat->slug)}}">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="{{url('/category/show/'.$cat->slug)}}">
    <script type="application/ld+json">
        {
          "@context": "{{url('/category/show/'.$cat->slug)}}",
          "@type": "Category",
          "name": "{{$cat->name}}",
          "image": "{{$cat->photo_id?$cat->photo->address:''}}",
