                ...
                <div class="cart-page-content col-12 order-1">
                    <section class="page-content default">
                        <div class="success-checkout text-center default">
                            ...
                            <h1>سفارش <a href="{{url('profile/orders/'.$order->id)}}">{{$order->id}}</a>با موفقیت در سیستم ثبت شد.</h1>
                        ...
                        <div class="order-info default">
                            ...
                            <a href="{{url('profile/orders/'.$order->id)}}" class="btn-primary">
                                پیگیری سفارش
                            </a>
                            <div class="table-responsive mt-5 mb-3">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row"> مرسوله </th>
                                        <td>مبلغ کل : {{ number_format($order->amount,0)}}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">وضعیت پرداخت : پرداخت آنلاین(موفق)</th>
                                        <td>وضعیت سفارش: <span class="badge badge-warning ft-16">در حال پردازش</span></td>
                                    </tr>
                                    <tr>
