        ...
        <div class="container">
            <div class="row">
                <div class="profile-page col-xl-9 col-lg-8 col-md-12 order-2">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="title-tab-content"> سفارشات من </h1>
                        </div>
                        @if($orders->isEmpty())
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach($orders as $order)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="text-info p-2" style="font-size: 20px !important;">
                                                                {{number_format($order->amount,0) }}
                                                                <span class="px-2 text-info">تومان</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td style="font-size: 20px !important;">
                                                            @if($order->status_send=='send')
                                                                <div class="badge badge-success"> {{$order->status_send()}}</div>
                                                            @elseif($order->status_send=='sending')
                                                                <div class="badge badge-info"> {{$order->status_send()}}</div>
                                                            @else
                                                                <div class="badge badge-danger"> {{$order->status_send()}}</div>
                                                            @endif
                                                        </td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="5" class="text-center">{{$orders->appends(Request::except('page'))->render('pagination::bootstrap-4')}}</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
