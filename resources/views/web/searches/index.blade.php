...
@endphp
    ...
    <main class="search-page default">
        <div class="container">
            <div class="row">
                <aside class="sidebar-page col-12 col-sm-12 col-md-4 col-lg-3 order-1 order-md-0">
                    <form action="{{ route('products.search') }}" method="GET">
                        ...
                        <div class="box mt-4">
                            <div class="box-header">
                                <div class="box-toggle" data-toggle="collapse" href="#collapseCategories" role="button">
                                    دسته‌بندی نتایج
                                    <i class="now-ui-icons arrows-1_minimal-down"></i>
                                </div>
                            </div>
                            <div class="box-content collapse show" id="collapseCategories">
                                    ...
                                    @foreach($categories as $category)
                                        <div class="checkbox">
                                            <input
                                                ...
                                                name="category[]"
                                                value="{{ $category->id }}"
                                                @checked(request()->filled('category') && in_array($category->id, (array) request('category')))
                                            >
                        ...
                        <div class="box">
                            <div class="box-header">
                                <div class="box-toggle" data-toggle="collapse" href="#collapseBrands" role="button">
                                    برند
                                    <i class="now-ui-icons arrows-1_minimal-down"></i>
                                </div>
                            </div>
                            <div class="box-content collapse show" id="collapseBrands">
                                <div class="filter-option">
                                    @foreach($brands_show as $brand)
                                        <div class="checkbox">
                                            <input
                                                ...
                                                class="brand"
                                                value="{{ $brand->id }}"
                                                @checked(request()->filled('brand') && in_array($brand->id, (array) request('brand')))
                                            >
                ...
                <div id="products" class="col-12 col-sm-12 col-md-8 col-lg-9 order-0 order-md-1">
